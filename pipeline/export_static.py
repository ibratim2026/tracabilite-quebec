...
def main():
    ...
    graines = ["/", "/aux-nouvelles", "/aux-nouvelles/saaqclic",
               ...
               "/election/mandat-en-cours", "/election/decoder", "/election/mieux-voter", "/election/jouer", "/etat-du-quebec", "/secteurs", "/economie-expliquee", "/quebec-canada", "/lois-et-projets", "/on-clarifie", "/ce-qui-s-en-vient", "/relever-le-quebec",
